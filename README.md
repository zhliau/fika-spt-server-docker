...
| `FIKA_VERSION`            | v2.4.7  | Override the fika version string to grab the server release from. The release URL is formatted as `https://github.com/project-fika/Fika-Server/releases/download/$FIKA_VERSION/fika-server-$FIKA_VERSION.zip` |
...
# Downloads and validates Fika version v2.4.7

VERSION=latest FIKA_VERSION=v2.4.7 SPT_SHA=3.11.3 ./build
```
